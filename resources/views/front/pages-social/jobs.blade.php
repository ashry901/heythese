        ...
        <div class="row">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l1.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p1.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p2.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p3.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p4.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p5.png')}}" alt="">
                                                    </div>
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l2.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p6.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p7.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p8.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l3.png')}}" alt="...">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p9.png')}}" alt="...">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p10.png')}}" alt="...">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p11.png')}}" alt="...">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p12.png')}}" alt="...">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l4.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p13.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p1.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p2.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p3.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l5.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p4.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p5.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p6.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p7.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l6.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p8.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p9.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p10.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p11.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l7.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p12.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p13.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p2.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/social/img/l8.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                        ...
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p7.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p1.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p3.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                ...
                                <div class="row">
                                        ...
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/social/img/l3.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                                        <h6 class="font-weight-bold mb-0">
                                                            <a class="text-dark" href="#">C# Developer</a>
                                                        </h6>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/social/img/l2.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                                        <h6 class="font-weight-bold mb-0">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/social/img/l3.png')}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/social/img/l4.png')}}"
                                                         alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/social/img/l5.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                                        <h6 class="font-weight-bold mb-0">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/social/img/l6.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                            ...
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p2.png')}}" alt="">
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p6.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p7.png')}}" alt="" data-original-title="John Doe">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p8.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p9.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p3.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p10.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p11.png')}}" alt="" data-original-title="John Doe">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p12.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p13.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p4.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p1.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p3.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/social/img/p4.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p5.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p5.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p6.png')}}" alt="" data-original-title="John Doe">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p7.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p8.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p6.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p9.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p13.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/social/img/p8.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p7.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                        <h6 class="font-weight-bold text-dark mb-0">Julia Cox</h6>
                                                        <div class="small text-black-50">Art Designer</div>
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p8.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                        <h6 class="font-weight-bold text-dark mb-0">Robert Cook</h6>
                                                        <div class="small text-black-50">Graphic Designer</div>
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile-social') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/social/img/p9.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                        <h6 class="font-weight-bold text-dark mb-0">Stella Bergmann</h6>
                                                        <div class="small text-black-50">Photography</div>
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
                <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center overflow-hidden">
                    <img src="{{asset('ashry/social/img/job1.png')}}" class="img-fluid" alt="Responsive image">
                ...
                <div class="shadow-sm rounded bg-white job-item-2 p-3 mb-3">
                    <div class="media">
                        <div class="u-avatar mr-3">
                            <img class="img-fluid"
                                 src="{{asset('ashry/social/img/l3.png')}}"
                                 alt="Image Description">
                        </div>
                        <div class="media-body">
                            <div class="mb-3">
                ...
                <div class="shadow-sm  rounded bg-white job-item-2 p-3 mb-3">
                    <div class="media">
                        <div class="u-avatar mr-3">
                            <img class="img-fluid"
                                 src="{{asset('ashry/social/img/l2.png')}}"
                                 alt="Image Description">
                        </div>
                        <div class="media-body">
                            <div class="mb-3">
            ...
            <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle"
                                     src="{{asset('ashry/social/img/p10.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/p11.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/p12.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
