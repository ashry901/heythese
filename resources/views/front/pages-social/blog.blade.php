                ...
                <div class="row">
                        ...
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/1.png')}}"
                                     alt="...">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/3.jpg')}}"
                                             alt="Card image cap">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/2.png')}}" alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/2.jpg')}}" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 05, 2020</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/3.png')}}" alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/1.jpg')}}"
                                             alt="Card image cap">
                                        <strong>Rahul Yadav</strong>
                                        On October 06, 2020
                                    </p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/ashry/front/img/blog/4.png')}}"
                                     alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/4.jpg')}}"
                                             alt="Card image cap">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/5.png')}}" alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/5.jpg')}}" alt="Card image cap">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/6.png')}}" alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/1.jpg')}}" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 06, 2020</p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/7.png')}}" alt="Card image cap">
                                <div class="card-body">
                                    <span class="badge badge-success">House/Villa</span>
                                    <h6 class="text-dark">Possimus aut mollitia eum ipsum</h6>
                                    <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus aut mollitia eum ipsum fugiat odio officiis odit.</p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/8.png')}}" alt="Card image cap">
                                <div class="card-body">
                                    <span class="badge badge-danger">Shop/Showroom</span>
                                    <h6 class="text-dark">Consectetur adipisicing elit</h6>
                                    <p class="mb-0">Cnsectetur ipsum dolor sit amet, consectetur adipisicing elit. Possimus aut mollitia eum ipsum fugiat odio officiis odit.</p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
                            <a href="#">
                                <img class="card-img-top"
                                     src="{{asset('ashry/social/img/blog/9.png')}}" alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer border-0">
                                    <p class="mb-0">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/social/img/user/2.jpg')}}" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 06, 2020</p>
                                </div>
                            </a>
                        </div>
                    </div>
