                                                ...
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('ashry/social/img/p1.png')}}" alt="">
                                                    </div>
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p6.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p7.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p8.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p9.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('ashry/social/img/p3.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/social/img/p10.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/social/img/p11.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p12.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p13.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('ashry/social/img/p4.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('ashry/social/img/p5.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('ashry/social/img/p6.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        ...
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/social/img/p13.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/social/img/p8.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('ashry/social/img/p8.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                        <h6 class="font-weight-bold text-dark mb-0">Robert Cook</h6>
                                                        <div class="small text-black-50">Graphic Designer</div>
            ...
            <aside class="col col-xl-3 order-xl-2 col-lg-12 order-lg-2 col-12">
                ...
                <div class="box shadow-sm mb-3 border rounded bg-white ads-box text-center">
                    <div class="image-overlap-2 pt-4">
                        <img src="{{asset('ashry/social/img/l4.png')}}" class="img-fluid rounded-circle shadow-sm"
                             alt="Responsive image">
                        <img src="{{asset('ashry/social/img/user.png')}}" class="img-fluid rounded-circle shadow-sm"
                             alt="Responsive image">
                    </div>
