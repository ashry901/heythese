...
<div class="profile-cover text-center">
    <img class="img-fluid" src="{{asset('ashry/social/img/company-profile.jpg')}}" alt="...">
</div>
        ...
        <div class="row">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="box mb-3 shadow-sm border rounded bg-white osahan-post">
                            ...
                            <div class="p-3 border-bottom osahan-post-body">
                                ...
                                <img src="{{asset('ashry/social/img/post1.png')}}"
                            ...
                            <div class="p-3 d-flex align-items-top border-bottom osahan-post-comment">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle"
                                         src="{{asset('ashry/social/img/p7.png')}}" alt="">
                                    <div class="status-indicator bg-success"></div>
                                </div>
                                <div class="font-weight-bold">
                                        ...
                                        <div class="border job-item mb-3">
                                            <div class="d-flex align-items-center p-3 job-item-header">
                                                ...
                                                <img class="img-fluid ml-auto"
                                                     src="{{asset('ashry/social/img/l1.png')}}" alt="...">
                                            </div>
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                         title="..."
                                                         src="{{asset('ashry/social/img/p1.png')}}"
                                                         alt="..." data-original-title="Sophia Lee">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                         title="..."
                                                         src="{{asset('ashry/social/img/p2.png')}}"
                                                         alt="..." data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                         title="..."
                                                         src="{{asset('ashry/social/img/p3.png')}}"
                                                         alt="..." data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                         title="..."
                                                         src="{{asset('ashry/social/img/p4.png')}}"
                                                         alt="..." data-original-title="Robert Cook">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                         title="..."
                                                         src="{{asset('ashry/social/img/p5.png')}}"
                                                         alt="..." data-original-title="Sophia Lee">
                                                </div>
                                    ...
                                    <a href="{{ route('job-profile') }}">
                                        <div class="border job-item mb-3">
                                            <div class="d-flex align-items-center p-3 job-item-header">
                                                ...
                                                <img class="img-fluid ml-auto"
                                                     src="{{asset('ashry/social/img/l2.png')}}" alt="...">
                                            </div>
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm"
                                                         data-toggle="tooltip" data-placement="top"
                                                         title="" src="{{asset('ashry/social/img/p6.png')}}" alt=""
                                                         data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm"
                                                         data-toggle="tooltip" data-placement="top"
                                                         title="" src="{{asset('ashry/social/img/p7.png')}}" alt=""
                                                         data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm"
                                                         data-toggle="tooltip" data-placement="top"
                                                         title="" src="{{asset('ashry/social/img/p8.png')}}" alt=""
                                    ...
                                    <a href="{{ route('job-profile') }}">
                                        <div class="border job-item mb-3">
                                            <div class="d-flex align-items-center p-3 job-item-header">
                                                ...
                                                <img class="img-fluid ml-auto"
                                                     src="{{asset('ashry/social/img/l3.png')}}" alt="">
                                            </div>
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p9.png')}}" alt="" data-original-title="Sophia Lee">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p10.png')}}" alt="" data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p11.png')}}" alt="" data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p12.png')}}" alt="" data-original-title="Robert Cook">
                                                </div>
                                                <span class="font-weight-bold text-primary">18 connections</span>
                                            </div>
                                            <div class="p-3 job-item-footer">
                                    ...
                                    <a href="{{ route('job-profile') }}">
                                        <div class="border job-item mb-3">
                                            <div class="d-flex align-items-center p-3 job-item-header">
                                                ...
                                                <img class="img-fluid ml-auto"
                                                     src="{{asset('ashry/social/img/l4.png')}}" alt="">
                                            </div>
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p13.png')}}" alt="" data-original-title="Sophia Lee">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p1.png')}}" alt="" data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p2.png')}}" alt="" data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p3.png')}}" alt="" data-original-title="Robert Cook">
                                                </div>
                                                <span class="font-weight-bold text-primary">18 connections</span>
                                            </div>
                                            <div class="p-3 job-item-footer">
                                    ...
                                    <a href="{{ route('job-profile') }}">
                                        <div class="border job-item mb-3">
                                            ...
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p4.png')}}" alt="" data-original-title="Sophia Lee">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p5.png')}}" alt="" data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p6.png')}}" alt="" data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p7.png')}}" alt="" data-original-title="Robert Cook">
                                                </div>
                                                <span class="font-weight-bold text-primary">18 connections</span>
                                            </div>
                                            <div class="p-3 job-item-footer">
                                    ...
                                    <a href="{{ route('job-profile') }}">
                                        <div class="border job-item mb-3">
                                            ...
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p8.png')}}" alt="" data-original-title="Sophia Lee">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p9.png')}}" alt="" data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p10.png')}}" alt="" data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p11.png')}}" alt="" data-original-title="Robert Cook">
                                                </div>
                                                <span class="font-weight-bold text-primary">18 connections</span>
                                            </div>
                                            <div class="p-3 job-item-footer">
                                    ...
                                    <a href="{{ route('job-profile') }}">
                                        <div class="border job-item mb-3">
                                            <div class="d-flex align-items-center p-3 job-item-header">
                                                ...
                                                <img class="img-fluid ml-auto"
                                                     src="{{asset('ashry/social/img/l8.png')}}" alt="">
                                            </div>
                                            <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                <div class="overlap-rounded-circle">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p5.pn')}}g" alt="" data-original-title="Sophia Lee">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p6.png')}}" alt="" data-original-title="John Doe">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p7.png')}}" alt="" data-original-title="Julia Cox">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p1.png')}}" alt="" data-original-title="Robert Cook">
                                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title=""
                                                         src="{{asset('ashry/social/img/p3.png')}}" alt="" data-original-title="Robert Cook">
                                                </div>
                                                <span class="font-weight-bold text-primary">18 connections</span>
                            ...
                            <div class="box-body p-3">
                                <div id="retro-comments">
                                    <div class="reviews-members pt-0">
                                        <div class="media">
                                            <a href="#">
                                                <img class="mr-3" src="{{asset('ashry/social/img/p4.png')}}"
                                    ...
                                    <div class="reviews-members">
                                        <div class="media">
                                            <a href="#">
                                                <img class="mr-3"
                                                     src="{{asset('ashry/social/img/p3.png')}}" alt="Generic placeholder image"></a>
                                            <div class="media-body">
                                    ...
                                    <div class="reviews-members">
                                        <div class="media">
                                            <a href="#"><img alt="Generic placeholder image"
                                                             src="{{asset('ashry/social/img/p2.png')}}" class="mr-3"></a>
                                            <div class="media-body">
                                                <div class="reviews-members-header">
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
                <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                    <div class="p-5">
                        <img src="{{asset('ashry/social/img/clogo.png')}}"
                             class="img-fluid" alt="Responsive image">
                    </div>
            ...
            <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/l1.png')}}" alt="">
                            </div>
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/l2.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/l3.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/l4.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle"
                                     src="{{asset('ashry/social/img/l5.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold mr-2">
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/social/img/p10.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold mr-2">
                ...
                <div class="box shadow-sm mb-3 border rounded bg-white ads-box text-center">
                    <img src="{{asset('ashry/social/img/ads1.png')}}" class="img-fluid" alt="Responsive image">
                    <div class="p-3 border-bottom">
