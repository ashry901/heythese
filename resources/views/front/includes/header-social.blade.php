<nav class="navbar navbar-expand navbar-dark bg-dark osahan-nav-top p-0">
    <div class="container">
        <a class="navbar-brand mr-2" href="{{ route('main') }}">
            <img src="{{asset('ashry/social/img/logo/logompn.png')}}" alt="...">
        ...
        <ul class="navbar-nav ml-auto d-flex align-items-center">
            ...
            <li class="nav-item dropdown mr-2">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow-sm">
                    ...
                    <a class="dropdown-item" href="{{ route('profile-social') }}">
                       ...
                       href="{{ route('messages') }}">
                        <div class="dropdown-list-image mr-3">
                            <img class="rounded-circle"
                                 src="{{asset('ashry/social/img/p2.png')}}" alt="">
                ...
                <a class="nav-link dropdown-toggle pr-0" href="#" role="button"
                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="img-profile rounded-circle"
                         src="{{asset('ashry/social/img/p13.png')}}">
                </a>
