        ...
        <div class="container text-light">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <small class="pre-label d-none d-lg-block">My Profile</small>
                </div>
            ...
            <div class="col-lg-9 pt-lg-4">
                ...
                <div class="bg-white p-4 p-lg-5 br-sm shadow-sm mb-3 mb-lg-5">
                    <div class="form-group">
                        <label class="pre-label pre-label-sm" for="old-pass">
                            Old password
                        </label>
                        <input class="form-control form-control-simple"
                               type="password" id="old-pass" value="">
                    </div>
                    <div class="form-group">
                        <label class="pre-label pre-label-sm" for="new-pass">
                            New password
                        </label>
                        <input class="form-control form-control-simple"
                               type="password" id="new-pass" value="">
                    </div>
                    <div class="form-group">
                        <label class="pre-label pre-label-sm" for="new-pass-rep">
                            Repeat New password
                        </label>
                        <input class="form-control form-control-simple"
                               type="password" id="new-pass-rep" value="">
                    </div>
