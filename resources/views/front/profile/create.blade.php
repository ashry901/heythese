                ...
                <div class="bg-white p-4 p-lg-5 br-sm shadow-sm mb-3 mb-lg-5">
                    ...
                    <form class="form" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-left py-4">
                    ...
                    <div class="card card-fill mb-3 shadow-sm rounded">
                        <div class="card-header p-3 p-md-5">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio5" name="customRadio" class="custom-control-input" data-toggle="collapse" data-target="#collapseTwo" aria-controls="collapseTwo">
                                        <label class="custom-control-label pl-2 pl-lg-4" for="customRadio5">
                                            <span class="h5 m-0">Service Provider</span><br />
                ...
                <div class="py-3">
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-6 text-right">
                            <a href="checkout-login.html" class="btn btn-primary btn-rounded px-lg-5">
                                Next step
                            </a>
                        </div>
                    </div>
