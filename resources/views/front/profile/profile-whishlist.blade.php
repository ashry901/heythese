        ...
        <div class="container text-light">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <small class="pre-label d-none d-lg-block">My Whishlist</small>
                </div>
                        ...
                        <div class="row align-items-center no-gutters p-md-2">
                            <div class="col-lg-2">
                                <img src="{{asset('ashry/front/assets/images/demo/product-1.png')}}"
                                     class="img-fluid br-sm shadow-sm" alt="...">
                            </div>
                            ...
                            <div class="col-6 col-lg-2 text-right">
                                <div class="dropdown d-inline">
                                    <button class="btn btn-icon btn-rounded btn-outline-gray"
                                            type="button"
                        ...
                        <div class="row align-items-center no-gutters p-md-2">
                            <div class="col-lg-2">
                                <img src="{{asset('ashry/front/assets/images/demo/product-2.png')}}"
                                     class="img-fluid br-sm shadow-sm"
                                     alt="...">
                            </div>
                            <div class="col-lg-5 pl-lg-3 py-2 py-lg-0">
                                <div><small class="pre-label">Name</small></div>
                    ...
                    <div class="card card-fill p-3 mb-3 shadow-sm bg-white">
                        ...
                        <div class="row align-items-center no-gutters p-md-2">
                            ...
                            <div class="col-6 col-lg-2 text-right">
                                <div class="dropdown d-inline">
                                    <button class="btn btn-icon btn-rounded btn-outline-gray"
                                            type="button" id="dropdownMenuButton-3"
                                            data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                                        <i class="icon icon-menu text-dark"></i>
                                    </button>
