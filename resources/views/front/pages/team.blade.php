...
<section class="bg-light-dark">
    <div class="container mt-lg-n7 mt-xl-n8">

        <div class="row no-gutters">

            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.0s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-1.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">John</b>
                                <span>Bayly</span>
                            </h4>
                            <p>CEO</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.1s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-2.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">Emma</b>
                                <span>Mance</span>
                            </h4>
                            <p>Manager</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.2s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-3.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">William</b>
                                <span>Kores</span>
                            </h4>
                            <p>Designer</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.3s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-4.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">Sophia</b>
                                <span>Guess</span>
                            </h4>
                            <p>Architect</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.4s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-5.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">Lanny</b>
                                <span>Stanway</span>
                            </h4>
                            <p>SEO</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.5s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-6.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">Anna</b>
                                <span>Genicke</span>
                            </h4>
                            <p>Administration</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.6s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-7.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">James</b>
                                <span>Tomasek</span>
                            </h4>
                            <p>Designer</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.7s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-8.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">Megan</b>
                                <span>Jacobsohn</span>
                            </h4>
                            <p>Developer</p>
                        </div>
            ...
            <div class="col-6 col-lg-4">
                <div class="wow fadeInUp" data-wow-delay="1.8s">
                    <div class="box box-image box-hover-drop shadow-sm" style="background-image:url(assets/images/demo/user-9.jpg)">
                        <div class="box-spacer-lg"></div>
                        <div class="box-content text-white">
                            <h4 class="mb-1 font-weight-normal">
                                <b class="text-uppercase p-1">Luna</b>
                                <span>Riddel</span>
                            </h4>
                            <p>Consultant</p>
                        </div>
