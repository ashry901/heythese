...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">
            {{ trans('cpanel/grades.Grades') }}
        </h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="">{{ trans('cpanel/grades.Dashboard') }}</a>
                    </li>
                    <li class="breadcrumb-item active">
                        {{ trans('cpanel/grades.All Grades') }}
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="heading-elements mt-0">
                            <button class="btn btn-primary"
                                ...
                                <span class="d-md-block d-none">
                                    {{ trans('cpanel/grades.Add New Grades') }}
                                </span>
                            </button>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">
                                                                {{ trans('cpanel/grades.Grade Name Ar') }}
                                                            </label>
                                                            <input type="text"
                                                                   id="name"
                                                                   class="form-control"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput2">
                                                                {{ trans('cpanel/grades.Grade Name Er') }}
                                                            </label>
                                                            <input type="text"
                                                                   class="form-control"
                                                                   name="name_en">
                            ...
                            <table id="users-contacts"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('cpanel/grades.Notes') }}</th>
                                                ...
                                                <form action="{{ route('grades.update', 'test') }}"
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel1">
                                                            {{ trans('cpanel/grades.Edit Grade') }}
                                                        </h5>
