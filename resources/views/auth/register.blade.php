            ...
            <div class="col-lg-10 col-xl-8">
                <div class="accordion" id="accordion1">
                    ...
                    <div class="card card-panel bg-white shadow-sm mb-2">
                        ...
                        <div class="card-header py-4 bg-white" role="button"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="name" type="text"
                                                           class="form-control form-control-simple @error('name') is-invalid @enderror"
                                                           name="name"
                                                           value="{{ old('name') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="email"
                                                           type="email"
                                                           class="form-control form-control-simple @error('email') is-invalid @enderror"
                                                           name="email"
                                                           value="{{ old('email') }}"
                                                           placeholder="Email: *"
                                                           required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="password"
                                                           type="password"
                                                           class="form-control form-control-simple @error('password') is-invalid @enderror"
                                                           name="password"
